...
class RDB extends \Fox\ORM\Repository
{
    ...
    public function find(array $params = array(), $deleted = false)
    {
        $this->handleSelectParams($params);
        $params = $this->getSelectParams($params);

        $dataArr = $this->getMapper()->select($this->seed, $params, $deleted);
    ...
    public function count(array $params = array(), $deleted = false)
    {
        ...
        $params = $this->getSelectParams($params);
        $count = $this->getMapper()->count($this->seed, $params, $deleted);
        $this->reset();
        return $count;
    }
