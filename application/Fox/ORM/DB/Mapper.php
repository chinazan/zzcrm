...
abstract class Mapper implements IMapper
{
    ...
    public function count(IEntity $entity, $params = array(), $deleted = false)
    {
        return $this->aggregate($entity, $params, 'COUNT', 'id', $deleted);
    }
    ...
    public function select(IEntity $entity, $params = array(), $deleted = false)
    {
